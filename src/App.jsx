...
const CHAT_VIEWS = ["agro", "cultura", "turismo", "trazabilidad"];
...
export default function App() {
  ...
  const isChatView = (id) => CHAT_VIEWS.includes(id);
  ...
  const renderView = () => {
    switch (activeNav) {
      ...
      case "agro":
        return <ChatPanel reserveComposerSpace={showVerify} />;
            ...
            element={
              <ProtectedRoute>
                <div className="app-shell">
                  ...
                  {renderView()}
                  {showVerify && isChatView(activeNav) && (
                    <VerifyPanel onClose={() => setShowVerify(false)} />
                  )}
                </div>
              </ProtectedRoute>
            }
